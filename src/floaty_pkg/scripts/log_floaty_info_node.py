...
if __name__ == '__main__':
    ...
    data_file_path = rospy.get_param("/floaty_info_recorder/data_file_path", "/home/floaty/Floaty/ws/src/floaty_pkg/data/iterative_learning_algorithm/floaty_estimator/")
